        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeManagerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GpName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GpLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GpPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FamilyMemberName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FamilyMemberPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    HasInheritance = table.Column<bool>(type: "bit", nullable: false),
                    HasSupportContract = table.Column<bool>(type: "bit", nullable: false),
                    HasRealEstateSale = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResidentInfos_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ResidentInfos_AspNetUsers_EmployeeManagerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResidentInfos_ApplicationUserId",
                table: "ResidentInfos",
                column: "ApplicationUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ResidentInfos_EmployeeManagerId",
                table: "ResidentInfos",
