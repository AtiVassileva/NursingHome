...
namespace NursingHome.DAL.Migrations
{
    ...
    [Migration("20250519162034_AddRegulatoryDocuments")]
    partial class AddRegulatoryDocuments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NursingHome.DAL.Models.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NursingHome.DAL.Models.WorkSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NursingHome.DAL.Models.Message", b =>
                {
                    b.HasOne("NursingHome.DAL.Models.ApplicationUser", "Sender")
                        .WithMany()
